...
class CalcStats:
    ...
    def calc_mismatches_by_score_range(self, data, ranges, match_type='top1_match',score_type='top1_score'):
        """
        ...
        # Calculate the number of mismatches for each score range
        mismatches_by_range = data[data['curated_ontology'] != data['top1_match']].groupby('score_range').size().to_dict()
