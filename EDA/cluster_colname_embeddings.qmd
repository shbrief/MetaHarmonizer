...
Create target column name embeddings with context
...
`target_colname_embeddings_with_context.csv` was created from [here](https://drive.google.com/file/d/1CdtvIS7HqVIIMKngsGv7I4VMdoIq6WcK/view?usp=sharing)
...
top_n_accuracy %>%
    ...
    labs(title = paste("Schema Mapping accuracy with top", n, "nearest embeddings"), 
