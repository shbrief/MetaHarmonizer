...
- **demo_OM_2_stage.ipynb** – Early two-stage Ontology Mapper prototype.
- **experiments_for_OM_small_corpus.ipynb** – Ontology Mapper experiments on a small corpus.
- **schema_map_demo.ipynb** – Initial demonstration of the Schema Mapper.
- **schema_mapping_evaluation.ipynb** – Early evaluation scripts for Schema Mapper performance.

## 📂 Current Useful Demo
- **ontology_mapper_workflow.ipynb** – The main, up-to-date demonstration of the Ontology Mapper workflow.  
