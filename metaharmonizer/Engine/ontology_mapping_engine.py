from metaharmonizer.models import ontology_mapper_st as oms
from metaharmonizer.models import ontology_mapper_lm as oml
from metaharmonizer.models import ontology_mapper_rag as omr
from metaharmonizer.models import ontology_mapper_synonym as omsyn
from metaharmonizer.models import ontology_mapper_bi_encoder as ombe
import os
import re
import pandas as pd
import numpy as np
...
class OntoMapEngine:
    ...
    def _map_shortname_to_fullname(self, non_exact_list: list[str]) -> dict:
        ...
        """
        try:
            mapping_df = pd.read_csv(resolve_data_file(ABBR_DICT_REL))
            short_to_name = dict(
