...
class FTSSynonymDb:
    ...
    def __init__(self, category: str, ontology_source: str = 'ncit'):
        ...
        if not umls_api_key:
            raise EnvironmentError(
                "UMLS_API_KEY environment variable is required for FTSSynonymDb."
            )
    ...
    async def build_index_from_codes(self,
        ...
        """
        Build FTS5 index from ontology codes.
        Routes NCIT codes to NCI API and non-NCIT codes to OLS API.
